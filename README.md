...
- **ML & Deep Learning:** PyTorch, TensorFlow, scikit-learn, computer vision (OpenCV), model training & evaluation
- **AI Systems:** RAG pipeline design and deployment, applied ML for structured and unstructured health data
- **Backend & Deployment:** FastAPI, REST API design, local + production model deployment
- **Data:** Pandas, SQL, Jupyter, Power BI, data pipeline design
- **Tooling:** Git/GitHub, Retool, Lovable
